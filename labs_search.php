    ...
    <div id="content_div" align="center" style="margin: 0px 0px 20px 0px;">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">LABORATORY/IMAGING RESULT MODULE</h3>
            </div>
            <form action="labs_search.php" name="search_consultation_form" method="GET">
                        ...
                        <tr>
                            <td colspan="5" align="center">
                                ...
                                <input
                                        ...
                                        value="Clear"
                                        title="Clear"
                                        onclick="window.location='labs_search.php'"
                                />
                            </td>
                        </tr>
                    </table>
            ...
            <div id="result" style="margin: 30px 0px 30px 0px;" align="center">
                <?php
                if($_GET) {
                    $displayResult = searchClientConsultation($pPIN, $pLastName, $pFirstName, $pMiddleName, $pSuffix, $pDateOfBirth, 'K');
                    ...
                    if (count($displayResult) == 0) {
                        ...
                        ?>
                        <table class="table table-hover table-bordered" style="margin-top: 20px; margin-bottom: 20px; font-size: 11px; text-align: center; width: 98%;">
                            <thead>
                                <tr>
                                    <th style="width: 5%; font-size: 11px; padding: 2px; vertical-align: middle"
                                        rowspan="2">No
                                    </th>
                                    <th style="width: 75%; font-size: 11px; padding: 2px;" colspan="11">Client Information
                                    </th>
                                </tr>
                                <tr>
                                    <th style="width: 12%; font-size: 11px; padding: 2px;vertical-align: middle">Case No</th>
                                    <th style="width: 12%; font-size: 11px; padding: 2px;vertical-align: middle">Trans No</th>
                                    ...
                                    <th style="width: 12%;  font-size: 11px; padding: 2px;vertical-align: middle">Consultation Date</th>
                                </tr>
                            </thead>
                            <?php
                            for ($i = 0; $i < count($displayResult); $i++) {
                                $pxCaseNo = $displayResult[$i]['CASE_NO'];
                                $pxTransNo = $displayResult[$i]['TRANS_NO'];
                                ...
                                $pConsultationDate = $displayResult[$i]['SOAP_DATE'];
                                ?>
                                <tbody>
                                <tr>
                                    <td><?php echo $i + 1; ?></td>
                                    <td><?php echo $pxCaseNo; ?></td>
                                    <td><a href="labs_data_entry.php?transno=<?php echo $pxTransNo; ?>"
                                    ...
                                    <td><?php echo $pConsultationDate; ?></td>
                                </tr>
                                </tbody>
                            <?php } ?>
                        </table>
            ...
            <div style="float: left; text-align: left; padding-top: 10px;font-weight: bold; font-size: 11px;color: #030303;">
                ...
                <li>Consultation records can be searched within this module.</li>
            </div>
