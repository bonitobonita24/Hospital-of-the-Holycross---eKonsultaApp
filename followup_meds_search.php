    ...
    <div id="content_div" align="center" style="margin: 0px 0px 20px 0px;">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">FOLLOW-UP MEDICINE MODULE</h3>
            </div>
            <form action="followup_meds_search.php" name="search_consultation_form" method="GET">
                    ...
                    if (count($displayResult) == 0) {
                        ...
                        <table class="table table-hover table-bordered"
                            ...
                            for ($i = 0; $i < count($displayResult); $i++) {
                                ...
                                <tr>
                                    <td><?php echo $i + 1; ?></td>
                                    <td><a href="followup_meds_list.php?case_no=<?php echo $pxCaseNo; ?>"
                                           title="Go to Medicine Record"
            ...
            <div style="float: left; text-align: left; padding-top: 10px;">
                <em style="font-weight: bold; font-size: 11px;color: #942a25;">
                    Note:<br>
                    <li>Only encoded 'registered client' could be searched from the system..</li>
                    <li>You may search by PhilHealth Identification Number OR by name and birthday.</li>
                </em>
            </div>
