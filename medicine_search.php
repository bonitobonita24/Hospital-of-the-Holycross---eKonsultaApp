    ...
    <div id="content_div" align="center" style="margin: 0px 0px 20px 0px;">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">MEDICINE MODULE</h3>
            </div>
            <form action="medicine_search.php" name="search_consultation_form" method="GET">
                    ...
                    if (count($displayResult) == 0) {
                        ...
                        <table class="table table-hover table-bordered"
                            ...
                            <tr>
                                ...
                                <th style="width: 12%;  font-size: 11px; padding: 2px;vertical-align: middle">With Medicine?</th>
                            </tr>
                            </thead>
                            <?php
                            for ($i = 0; $i < count($displayResult); $i++) {
                                ...
                                $withMedicine = getConsultationTransactionForMedicine($pxTransNo);
                                ?>
                                <tbody>
                                <tr>
                                    <td><?php echo $i + 1; ?></td>
                                    ...
                                    <td> <?php 
                                            if (!$withMedicine) {
                                               ?>
                                               <a href="medicine_data_entry.php?transno=<?php echo $pxTransNo; ?>"
                                               title="Go to Data Entry"
                                               style="font-size:11px;font-weight: normal;"><?php echo $pxTransNo; ?></a>
                                           <?php
                                            } else { ?>
                                               <?php echo $pxTransNo; ?>
                                           <?php
