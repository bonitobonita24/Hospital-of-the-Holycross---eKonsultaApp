...
function showTabHSA(id){
    ...
    if(id == 'tab7') {
        ...
        if(txtPhExSystolic == "" || txtPhExBPDiastolic == "" || txtPhExHeartRate == "" || txtPhExRespiratoryRate == "" || txtPhExHeightCm == "" || txtPhExWeightKg == "" || txtPhExTemp == "" || txtPhExVisualAcuityL == "" || txtPhExVisualAcuityL == ""){
