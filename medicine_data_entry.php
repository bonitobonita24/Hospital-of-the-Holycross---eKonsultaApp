...
error_reporting(E_ALL);
    ...
    /* START GET PATIENT RECORD BEFORE CONSULTATION*/
        if(isset($_GET['transno'])){
            $descPatientInfo = getConsultationEnlistInfo($_GET['transno']);

            if(!$descPatientInfo) {
                echo "<script>alert('Invalid Transaction Number. No record found.'); window.location='medicine_search.php';</script>";
            }
        }
    ...
    if(isset($_POST['submit'])) {
        if($_POST['pDrugCodeMeds'] != NULL || $_POST['pGenericNameMeds'] != NULL) {
            ...
            echo "<script>alert('Please add at least one medicine.');</script>";
        }
    }
...
<div id="content">
    ...
    <div id="content_div" align="center" style="margin: 0px 0px 0px 0px;">
                ...
                <td>
                    ...
                    <!-- <div align="left">
                        <font color="red" style="font-size: 10px; font-family: Verdana, Geneva, sans-serif;">
                            NOTE: <br/>
                            1. All fields marked with asterisk (*) are required.<br/>
                            2. In generation of the Konsulta XML Report for the encoded drug/medicines, always based in the Consultation Date of the applicable transaction.
                        </font>
                    </div> -->
                    <div align="center">
                        <table>
                            ...
                            <tr>
                                <td align="center">
                                    <input type="button"
                                           ...
                                           onclick="window.location='medicine_search.php'"
        ...
        <div style="float: left; text-align: left; font-weight: bold; font-size: 11px;color: #030303;">
            ...
            <li>When generating the Konsulta XML Report for the encoded drugs/medicines, always use the Consultation Date of the applicable transaction.</li>
        </div>
